...
export default function ClientHeader({
  ...
  return (
    <header className="sticky top-0 z-30 flex h-20 items-center border-b border-gray-200 bg-white px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <button
              ...
              className="
                ...
                p-1.5 transition hover:bg-gray-50
              "
            >
              {/* Avatar */}
            ...
            {/* Profile Dropdown */}
            {profileOpen && (
              <div className="absolute right-0 top-14 w-56 overflow-hidden rounded-2xl border border-gray-200 bg-white py-2 shadow-xl">
                ...
                <button
                  type="button"
                  className="flex w-full items-center gap-3 px-4 py-3 text-left text-sm font-medium text-red-500 hover:bg-red-50"
                >
                  <span>↪</span>
                  Logout
                </button>
